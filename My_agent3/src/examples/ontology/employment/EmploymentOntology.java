...
public class EmploymentOntology extends Ontology {
  ...
  public static final String PERSON_STAT = "criminalPast";
  ...
  public static final String PERSON_TOO_OLD = "CriminalPast";
  ...
  */
  ...
  private EmploymentOntology() {
    ...
    try {
    	...
    	cs.add(PERSON_STAT, (PrimitiveSchema)getSchema(BasicOntology.STRING),ObjectSchema.OPTIONAL);
