...
public class Person implements Predicate {
	...
	private String _criminalPast;         //Стать
	...
	public void setcriminalPast(String criminalPast) {
		_criminalPast=criminalPast;
	}
	public Long getAge() {
		return _age;
  }
	
	public String getcriminalPast() {
		return _criminalPast;
  }
	...
	public boolean equals(Person p){
		if (!_name.equalsIgnoreCase(p.getName()))
			return false;
		if (!_criminalPast.equalsIgnoreCase(p.getcriminalPast()))
			return false;
