...
public class FSMAgent extends Agent {
	...
	private static final String STATE_NATA = "NATA";
	...
	protected void setup() {
		...
		// Реєстрація стану F
		fsm.registerState(new NamePrinter(), STATE_F);
		// Register state NATA (final state)
		fsm.registerLastState(new NamePrinter(), STATE_NATA);
		...
		fsm.registerTransition(STATE_C, STATE_E, 3);
		fsm.registerTransition(STATE_C, STATE_D, 4);
		fsm.registerDefaultTransition(STATE_D, STATE_E);
		//fsm.registerTransition(STATE_E, STATE_NATA, 4);
		fsm.registerDefaultTransition(STATE_E, STATE_NATA);
